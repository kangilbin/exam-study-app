...
const PROD_REWARDED_INTERSTITIAL_ID = Platform.select({
  android: 'ca-app-pub-3001608230251687/4578408403',
  ios: 'ca-app-pub-XXXXXXXXXXXXXXXX/YYYYYYYYYY',
...
/** 보상형 전면 광고 단위 ID */
export const REWARDED_INTERSTITIAL_AD_UNIT_ID = IS_PRODUCTION ? PROD_REWARDED_INTERSTITIAL_ID : TEST_REWARDED_INTERSTITIAL_ID;
